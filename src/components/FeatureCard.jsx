...
export default function FeatureCard({ icon: Icon, title, description, delay = 0 }) {
  return (
    <motion.div
      ...
      className="glass-card p-8 rounded-2xl group transition-all duration-300 hover:scale-[1.02] hover:border-glow cursor-default relative overflow-hidden"
    >
      ...
      <div className="relative z-10">
        <div className="w-14 h-14 rounded-xl bg-slate-900 border border-slate-800 flex items-center justify-center mb-6 group-hover:border-[var(--accent-primary)]/50 transition-colors duration-300">
